...
AGENT_EXTERNAL_WAIT_TTL_SECONDS = int(os.getenv("AGENT_EXTERNAL_WAIT_TTL_SECONDS", "3600"))
AGENT_EXTERNAL_WAIT_CLEANUP_BATCH_SIZE = int(
    os.getenv("AGENT_EXTERNAL_WAIT_CLEANUP_BATCH_SIZE", "100")
)
...
if (
    ...
    or AGENT_EXTERNAL_WAIT_TTL_SECONDS < 1
    or AGENT_EXTERNAL_WAIT_CLEANUP_BATCH_SIZE < 1
